                        ...
                        {loading ? (
                            ...
                            <tr>
                                <td colSpan="5" className="px-6 py-8 text-center text-neutral-400">
                                    <FontAwesomeIcon icon={faStar} className="text-4xl mb-2 block" />
                                    No reviews found
                                </td>
                            </tr>
                        ) : (
                            reviews.map((review) => (
                                <tr key={review.id} className="hover:bg-neutral-750">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="flex items-center space-x-1">
                                            ...
                                            <span className="text-sm text-neutral-400 ml-2">({review.rating})</span>
                                        </div>
                                    </td>
