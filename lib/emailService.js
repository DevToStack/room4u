...
export const emailService = {
    async sendBookingConfirmation({ to, userName, apartmentTitle, bookingId, startDate, endDate, nextSteps }) {
        const mailOptions = {
            ...
            to,
            subject: `🎉 Booking Verified - ${apartmentTitle}`,
            html: `
            <!DOCTYPE html>
            <html lang="en">
            <head>
            ...
            <body>
                <div class="email-container">
                    <div class="header">
                        ...
                        <div class="progress-text">90% Complete - Almost Ready!</div>
                    </div>
                    ...
                    <div class="content">
                        ...
                        <div class="booking-card">
                            ...
                            <div class="detail-grid">
                                ...
                                <div class="detail-item">
                                    ...
                                    <span class="detail-value">${new Date(startDate).toLocaleDateString('en-US', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}</span>
                                </div>
                                <div class="detail-item">
                                    <span class="detail-label">📅 Check-out Date</span>
                                    <span class="detail-value">${new Date(endDate).toLocaleDateString('en-US', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}</span>
                                </div>
                                <div class="detail-item">
                        ...
                        <div class="tips-section">
                            <h4>💡 Helpful Tips</h4>
                            <ul class="tips-list">
                                <li>Save this email for easy access to your booking details</li>
                                <li>Add the check-in/out dates to your calendar</li>
                                <li>Review the apartment rules and amenities</li>
                                <li>Contact the host 24 hours before check-in for arrival instructions</li>
                                <li>Keep your ID ready for verification at check-in</li>
                            </ul>
                        </div>

                        <!-- CTA Button -->
                        <div style="text-align:center; margin:20px 0;">
                          <a href="${process.env.GUEST_DASHBOARD_URL}" style="display:inline-block; background-color:#14b8a6; color:#fff; text-decoration:none; font-weight:bold; padding:12px 24px; border-radius:6px; font-size:14px;">
                            Review & Confirm Booking
                          </a>
                        </div>

                        <p style="text-align: center; margin-top: 30px; font-weight: 600; color: #4CAF50;">
